...
College},,postcodesep={}}
\affiliation[2]{organization={Universidad Catolica
...
\fntext[fn1]{The opinions expressed in this paper are those of the
authors and do not necessarily reflect the views of the World Bank, its
Board of Directors, or the countries it represents}
...
Thurd, given the location and scale coefficients, the \(\tau_{th}\)
