...
[^7]: The derivation of the influence functions can be found in the appendix.
...
Afterwards, we estimate the location model using the centered-residualized variables:[^rc]
...
::: {#tbl-sim1 layout-nrow=2 layout-ncol=2}
