...
Here, the inner product is the moment covariance matrix, and $\bar{G}(\theta)$ is the Jacobian matrix of the moment equations (@eq-eq10) evaluated at $\hat\theta$.
