...
\makeatother
\usepackage{xcolor}
\usepackage[lmargin=1.1in,rmargin=1.1in,tmargin=1in,bmargin=1.2in]{geometry}
...
\caption{\label{tbl-ecuador}The Effect of Crime on Labor Income: Canton,
Activity Sector and Time Fixed Effects}
...
\caption{\label{tbl-acrime1}The Effect of Crime on Per Capita Household
Income: Canton and Time Fixed Effects}
...
\caption{\label{tbl-acrime2}The Effect of Crime on Labor Income in Main
Occupation: Canton, Activity Sector and Time FE}
